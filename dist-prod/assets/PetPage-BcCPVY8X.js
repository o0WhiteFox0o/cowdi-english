import{r as m,j as e}from"./react-nTLHQtbJ.js";import{L as y}from"./router-CxCaNF6T.js";import{a as re,u as de,b as me,P as S,e as X,h as pe,l as he,m as xe,D as ge,n as k,E as C,R as F,f as ve,o as fe,i as ue}from"./index-C6MYFMUM.js";import"./react-dom-Dp7c0bxT.js";import"./vendor-DSXEjpE4.js";import"./data-lessons-BVXBF808.js";import"./data-vocab-BtRUsb5n.js";function be({oldEvo:c,newEvo:x,petName:T,onComplete:b,onSkip:I}){const[d,j]=m.useState("intro");m.useEffect(()=>{const v=setTimeout(()=>j("flashing"),500),p=setTimeout(()=>j("reveal"),3e3),w=setTimeout(()=>{j("done"),b&&b()},3800);return()=>{clearTimeout(v),clearTimeout(p),clearTimeout(w)}},[]);const t=d==="reveal"||d==="done"?x:c;return e.jsxs("div",{className:"cowdi-evo-overlay",role:"dialog","aria-label":"Pet đang tiến hóa",children:[e.jsx("div",{className:`cowdi-evo-rays ${d}`}),e.jsx("div",{className:"cowdi-evo-sparkles",children:Array.from({length:14}).map((v,p)=>e.jsx("span",{className:"cowdi-evo-spark",style:{left:`${p*73%100}%`,top:`${p*41%100}%`,animationDelay:`${p*137%1800}ms`},children:"✨"},p))}),e.jsxs("div",{className:`cowdi-evo-stage ${d}`,children:[e.jsxs("div",{className:"cowdi-evo-pet-wrap",children:[t!=null&&t.image?e.jsx("img",{src:t.image,alt:t.name,className:"cowdi-evo-pet-img",draggable:!1}):e.jsx("span",{className:"cowdi-evo-pet-emoji",children:(t==null?void 0:t.emoji)||"🥚"}),e.jsx("div",{className:"cowdi-evo-flash"})]}),e.jsxs("div",{className:"cowdi-evo-caption",children:[d==="intro"&&e.jsxs("span",{children:[T||(c==null?void 0:c.name)," đang tiến hóa…"]}),d==="flashing"&&e.jsx("span",{children:"Một luồng sáng bao trùm…"}),(d==="reveal"||d==="done")&&e.jsxs("span",{className:"cowdi-evo-newname",children:["🎉 ",x==null?void 0:x.name,"!"]})]})]}),e.jsx("button",{type:"button",className:"cowdi-evo-skip",onClick:I,children:"Bỏ qua ›"}),e.jsx("style",{children:`
        .cowdi-evo-overlay {
